...
public class UpdateChunkLamps extends Thread{
    private boolean night;
    private LampChunk chunk;
    
    
    public UpdateChunkLamps(StreetLampsListener SLL, LampChunk chunk,  boolean night){
        this.night = night;
        this.chunk = chunk;
        this.setName("StreetLamps-UpdateChunkLampsThread-"+(night ? "ON" : "OFF"));
    }
